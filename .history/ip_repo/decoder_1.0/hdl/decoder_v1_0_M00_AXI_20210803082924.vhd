...
begin
	...
	--Read Address (AR)
	M_AXI_ARADDR	<= std_logic_vector(unsigned(targetSlave) + unsigned(axi_araddr)); --x"44A00000"; --
	...
	cdmaWriteFlagPulse <= cdmaWriteFlagF AND (NOT (cdmaWriteFlagFF));
	  ...
	  begin                                                                            
	    if (rising_edge (M_AXI_ACLK)) then                                             
	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' or rdDmaPulse = '1') then                                               
	        ...
	        if (start_single_read = '1' OR insFinishPulse = '1' OR cdmaWriteFlagPulse = '1') then                                          
