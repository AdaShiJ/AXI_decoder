...
begin
	...
	--case of differing reset latencies between master/slave.
	  ...
	  begin                                                                
	    if (rising_edge (M_AXI_ACLK)) then                                 
	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' or (cdmaWriteFinishPulseF = '1')) then                                   
	        axi_bready <= '0';                                             
	      else                                                             
	...
	--keep track with number of read transaction issued/initiated
	  ...
	  begin                                                                            
	    if (rising_edge (M_AXI_ACLK)) then                                             
	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' or rdDmaPulse = '1' or (cdmaWriteFinishPulseF = '1')) then                                               
	        read_index <= (others => '0');                                           
	      else                                                                         
	...
	--case of differing reset latencies between master/slave.
	  ...
	  begin                                                                 
	    if (rising_edge (M_AXI_ACLK)) then                                  
	      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' or rdDmaPulse = '1' or (cdmaWriteFinishPulse = '1')) then                                    
	        axi_rready <= '1';                                              
	      else                                                              
