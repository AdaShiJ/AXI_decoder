...
begin
	...
	M_AXI_AWADDR	<= 44A0_0000; --std_logic_vector(unsigned(C_M_CDMA_BASE_ADDR) + unsigned(axi_awaddr));-- std_logic_vector (unsigned(targetSlave) + unsigned(axi_awaddr));
	--AXI 4 write data
	...
	--Read Address (AR)
	M_AXI_ARADDR	<= 44A0_0000; --std_logic_vector(unsigned(targetSlave) + unsigned(axi_araddr));
