...
architecture STRUCTURE of decoderTest_decoder_0_0_decoder_v1_0_M00_AXI is
  ...
  signal pingpongFlag3_out : STD_LOGIC;
  signal pingpongFlag5_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of insDown2Flag_i_9 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of insFinish_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of insFlag_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \m00_axi_araddr[25]_INST_0\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of pingpongFlag_i_1 : label is "soft_lutpair5";
...
insDown2Flag_i_10: unisim.vcomponents.LUT6
    generic map(
...
pingpongFlag_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"D"
    )
        port map (
