...
HD_PWD='D:/VIVADO/decoderTest/decoderTest/decoderTest.runs/decoderTest_decoder_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoderTest_decoder_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoderTest_decoder_0_0.tcl
