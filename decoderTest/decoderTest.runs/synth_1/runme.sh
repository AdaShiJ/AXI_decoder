...
HD_PWD='D:/VIVADO/decoderTest/decoderTest/decoderTest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoderTest_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoderTest_wrapper.tcl
