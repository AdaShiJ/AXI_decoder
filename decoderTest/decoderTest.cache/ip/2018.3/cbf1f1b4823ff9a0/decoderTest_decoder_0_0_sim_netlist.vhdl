...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal read_index03_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_mst_exec_state[0]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of axi_arvalid_i_2 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_2 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \read_index[1]_i_2\ : label is "soft_lutpair6";
...
\read_index[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF75"
    )
        port map (
