...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal cdmaWriteFlag22_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_mst_exec_state[0]_i_2\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \axi_araddr[2]_i_2\ : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \cdmaWriteFlag_reg__0_i_2\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_4 : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of insFlag_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of insUp2Flag_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of insUp2Flag_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of insUp2Flag_i_5 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of rdDmaFlag_i_1 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of read_issued_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of reads_done_i_1 : label is "soft_lutpair6";
  attribute XILINX_LEGACY_PRIM of resetFinish_reg : label is "LD";
  attribute XILINX_LEGACY_PRIM of writeFlag_reg : label is "LD";
  attribute SOFT_HLUTNM of writeFlag_reg_i_1 : label is "soft_lutpair6";
...
\cdmaWriteFlag_reg__0\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => cdmaWriteFlag22_out,
      G => cdmaWriteFlag25_out,
      GE => '1',
      Q => cdmaWriteFlag
    );
...
\controlWord[31]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"32"
    )
        port map (
...
rdDmaFlag_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E4"
    )
        port map (
