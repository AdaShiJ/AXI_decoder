...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM of \axi_wdata[2]_i_2\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_4 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of compare_done_i_2 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \controlWord[2]_i_2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \counter[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of insDown1Flag_i_3 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_3\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of resetFinish_i_1 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of writeReset_i_1 : label is "soft_lutpair1";
...
\axi_wdata[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => axi_awvalid_i_1_n_0,
      O => \axi_wdata[2]_i_1_n_0\
    );
\axi_wdata[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
