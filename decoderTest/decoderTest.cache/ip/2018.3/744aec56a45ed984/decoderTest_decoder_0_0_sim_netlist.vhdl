...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal \DAFlag__0_i_1_n_0\ : STD_LOGIC;
  ...
  signal cdmaWriteFlag27_out : STD_LOGIC;
  ...
  signal cdmaWriteFlag_i_7_n_0 : STD_LOGIC;
  ...
  signal initCdmaWriteFlag_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of axi_awvalid_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \axi_wdata[14]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \axi_wdata[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \axi_wdata[2]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_2\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of axi_wvalid_i_1 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of cdmaWriteFinishPulse_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_6 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_7 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of compare_done_i_2 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \counter[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of initCdmaWriteFlag_i_2 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of initCdmaWriteFlag_i_3 : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of insDown1Flag_i_6 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of insDown1Flag_i_7 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of insDown2Flag_i_2 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of insDown2Flag_i_4 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of insDown2Flag_i_5 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of insDown2Flag_i_7 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of insDown2Flag_i_8 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of insFinishPulseF_i_1 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of insUp2Flag_i_3 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of last_write_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_3\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of start_single_read_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of start_single_read_i_4 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of start_single_write_i_1 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of start_single_write_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of writeFlag_i_1 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \write_index[0]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of writes_done_i_1 : label is "soft_lutpair11";
begin
...
\DAFlag__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF04"
    )
        port map (
...
\DAFlag_reg__0\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\axi_wdata[14]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \axi_wdata[14]_i_4_n_0\,
      I4 => \axi_wdata[14]_i_5_n_0\,
      I5 => DAFlag,
      O => \axi_wdata[14]_i_3_n_0\
    );
\axi_wdata[14]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\axi_wdata[14]_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
cdmaWriteFlag_i_6: unisim.vcomponents.LUT5
    generic map(
      INIT => X"15000000"
    )
        port map (
...
cdmaWriteFlag_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
...
initCdmaWriteFlag_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
initCdmaWriteFlag_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
