...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal axi_awaddr0_in : STD_LOGIC_VECTOR ( 31 to 31 );
  signal \axi_awaddr[2]_i_1_n_0\ : STD_LOGIC;
  signal \axi_awaddr[2]_i_2_n_0\ : STD_LOGIC;
  signal \axi_awaddr_reg_n_0_[25]\ : STD_LOGIC;
  signal \axi_awaddr_reg_n_0_[26]\ : STD_LOGIC;
  signal \axi_awaddr_reg_n_0_[27]\ : STD_LOGIC;
  signal \axi_awaddr_reg_n_0_[28]\ : STD_LOGIC;
  ...
  signal \NLW_M_AXI_AWADDR_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_M_AXI_AWADDR_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[2]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of axi_awvalid_i_1 : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \axi_wdata[0]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \axi_wdata[1]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of insFinishPulseF_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of insFinish_i_2 : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \m00_axi_araddr[25]_INST_0\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \m00_axi_awaddr[25]_INST_0\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of pingpongFlag_i_1 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of writeFlag_reg_i_1 : label is "soft_lutpair7";
  attribute XILINX_LEGACY_PRIM of \writeReset_reg__0\ : label is "LD";
  attribute SOFT_HLUTNM of \writeReset_reg__0_i_1\ : label is "soft_lutpair17";
...
M_AXI_AWADDR_carry: unisim.vcomponents.CARRY4
     port map (
      ...
      DI(3 downto 1) => B"000",
      DI(0) => targetSlave(25),
      O(3 downto 1) => \^m00_axi_awaddr\(28 downto 26),
      O(0) => NLW_M_AXI_AWADDR_carry_O_UNCONNECTED(0),
      S(3) => \axi_awaddr_reg_n_0_[28]\,
      S(2) => \axi_awaddr_reg_n_0_[27]\,
      S(1) => \axi_awaddr_reg_n_0_[26]\,
      S(0) => M_AXI_AWADDR_carry_i_1_n_0
    );
\M_AXI_AWADDR_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => M_AXI_AWADDR_carry_n_0,
      CO(3 downto 2) => \NLW_M_AXI_AWADDR_carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \M_AXI_AWADDR_carry__0_n_2\,
      CO(0) => \M_AXI_AWADDR_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0010",
      O(3) => \NLW_M_AXI_AWADDR_carry__0_O_UNCONNECTED\(3),
      O(2 downto 0) => \^m00_axi_awaddr\(31 downto 29),
      S(3) => '0',
      S(2) => \axi_awaddr_reg_n_0_[31]\,
      S(1) => \M_AXI_AWADDR_carry__0_i_1_n_0\,
...
\axi_awaddr[2]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\m00_axi_awaddr[25]_INST_0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
