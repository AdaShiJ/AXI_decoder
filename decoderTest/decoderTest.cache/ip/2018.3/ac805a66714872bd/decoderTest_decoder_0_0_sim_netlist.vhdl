...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal axi_araddr143_out : STD_LOGIC;
  ...
  signal rdDmaFlag_reg_n_0 : STD_LOGIC;
  ...
  signal writeFlag6_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_1 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \counter[2]_i_2\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of insDown1Flag_i_7 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of insDown2Flag_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of insDown2Flag_i_4 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of insDown2Flag_i_6 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of insDown2Flag_i_7 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of insFinishPulseF_i_1 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of insFinish_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of insFinish_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of insFlag_i_1 : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of pingpongFlag_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of rdDmaFlag_i_1 : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of read_issued_i_3 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of writeFlag_reg_i_2 : label is "soft_lutpair8";
...
cdmaWriteFlag_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AAEA"
    )
        port map (
...
writeFlag_reg_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
