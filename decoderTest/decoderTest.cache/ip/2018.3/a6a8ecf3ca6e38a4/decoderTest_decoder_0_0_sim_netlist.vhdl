...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_12 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of insFinish_i_2 : label is "soft_lutpair5";
...
insFinish_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => insFinish_i_2_n_0,
      O => insFinish_i_1_n_0
    );
insFinish_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01000000"
    )
        port map (
