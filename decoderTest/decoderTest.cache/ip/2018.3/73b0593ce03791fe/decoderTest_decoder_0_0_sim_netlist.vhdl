...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal rdDmaFlag_i_2_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_3 : label is "soft_lutpair8";
...
rdDmaFlag_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E4"
        ...
        port map (
      I0 => rdDmaFlag_i_2_n_0,
      I1 => writeFlag,
      I2 => rdDmaFlag,
      O => rdDmaFlag_i_1_n_0
    );
rdDmaFlag_i_2: unisim.vcomponents.LUT6
    generic map(
