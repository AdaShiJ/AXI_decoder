...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal axi_araddr141_out : STD_LOGIC;
  ...
  signal insFinishPulse43_out : STD_LOGIC;
  ...
  signal writeFlag18_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of pingpongFlag_i_1 : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of read_issued_i_3 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of start_single_read_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of start_single_write_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of start_single_write_i_3 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of \writeReset_reg__0_i_1\ : label is "soft_lutpair8";
...
read_issued_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F7FFFFFF00080008"
    )
        port map (
      I0 => reads_done,
      I1 => mst_exec_state(0),
      I2 => mst_exec_state(1),
      I3 => read_issued_i_2_n_0,
      I4 => \^axi_rready_reg_0\,
...
start_single_read_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
