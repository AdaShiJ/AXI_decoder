...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal cdmaWriteFlag5_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_araddr[24]_i_4\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_2 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of insUp2Flag_i_6 : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of start_single_write_i_1 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of write_issued_i_1 : label is "soft_lutpair9";
begin
...
cdmaWriteFlag_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AE"
    )
        port map (
