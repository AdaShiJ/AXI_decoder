...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal insFinishPulse57_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of DAFlag_i_2 : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \axi_wdata[14]_i_3\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \axi_wdata[14]_i_4\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \axi_wdata[2]_i_4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \axi_wdata[31]_i_4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \axi_wdata[3]_i_2\ : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_6 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of compare_done_i_2 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \counter[0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of initCdmaWriteFlag_i_2 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of initCdmaWriteFlag_i_3 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of insDown1Flag_i_3 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of insDown1Flag_i_4 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of insDown1Flag_i_6 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of insDown1Flag_i_7 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of insDown2Flag_i_2 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_7 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of insFinish_i_1 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of insFlag_i_1 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of insUp2Flag_i_2 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of insUp2Flag_i_3 : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of insUp2Flag_i_5 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of insUp2Flag_i_6 : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \mst_exec_state[1]_i_3\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \read_index[2]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of start_single_read_i_3 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of start_single_write_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of writeFlag_i_1 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \write_index[0]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of write_issued_i_1 : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of write_issued_i_2 : label is "soft_lutpair15";
begin
...
DAFlag_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\axi_wdata[14]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\axi_wdata[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \axi_wdata[2]_i_3_n_0\,
      I2 => \axi_wdata[2]_i_4_n_0\,
      I3 => controlWord(2),
      I4 => resetFinish,
      I5 => initInter,
...
\axi_wdata[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF0045FFC5"
    )
        port map (
      I0 => writeReset,
      I1 => initInter,
      I2 => resetFinish,
      I3 => \axi_wdata[2]_i_4_n_0\,
...
\axi_wdata[2]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
cdmaWriteFlag_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEAAAE"
        ...
        port map (
      I0 => cdmaWriteFlag_i_2_n_0,
      I1 => cdmaWriteFlag_reg_n_0,
      I2 => cdmaWriteFlag_i_3_n_0,
      I3 => cdmaWriteFlag_i_4_n_0,
...
cdmaWriteFlag_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
