...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal insFinishPulse46_out : STD_LOGIC;
  ...
  signal \writeReset_reg__0_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_araddr[4]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of axi_arvalid_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \axi_awaddr[4]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of axi_awvalid_i_1 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_6 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of insDown2Flag_i_7 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of insFinishPulseF_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of insFinish_i_2 : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of insFinish_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of insFlag_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of insUp2Flag_i_2 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of insUp2Flag_i_3 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of insUp2Flag_i_5 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of insUp2Flag_i_6 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of pingpongFlag_i_1 : label is "soft_lutpair15";
  ...
  attribute XILINX_LEGACY_PRIM of \resetFinish_reg__0\ : label is "LD";
  attribute SOFT_HLUTNM of start_single_read_i_2 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of writeFlag_reg_i_1 : label is "soft_lutpair9";
...
\axi_araddr[24]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FEFCFEFCF0FCFEFC"
    )
        port map (
      I0 => insFinishPulseF,
      I1 => writeReset,
      I2 => \axi_awaddr[4]_i_1_n_0\,
...
\axi_araddr[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
        ...
        port map (
      I0 => p_1_in(2),
      I1 => \axi_araddr[24]_i_2_n_0\,
      I2 => \^m00_axi_araddr\(1),
      O => \axi_araddr[2]_i_1_n_0\
    );
\axi_araddr[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000ACAA0000"
    )
        port map (
      I0 => insFinishPulseF,
...
\axi_awaddr_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => m00_axi_aclk,
      CE => '1',
      D => \axi_awaddr[4]_i_2_n_0\,
      Q => \^axi_awaddr_reg[4]_0\(0),
      R => \axi_awaddr[4]_i_1_n_0\
    );
...
\controlWord[31]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"3222"
    )
        port map (
...
resetFinish_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
\resetFinish_reg__0\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
    )
        port map (
...
writeFlag_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
writeReset_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BAAA"
    )
        port map (
...
\writeReset_reg__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
decoder_v1_0_M00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI
     port map (
      ...
      \axi_awaddr_reg[4]_0\(0) => m00_axi_awaddr(0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^m00_axi_awaddr\ : STD_LOGIC_VECTOR ( 25 downto 4 );
...
begin
  ...
  m00_axi_awaddr(4) <= \^m00_axi_awaddr\(4);
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0
     port map (
      ...
      m00_axi_aresetn => m00_axi_aresetn,
      m00_axi_arready => m00_axi_arready,
      m00_axi_awaddr(0) => \^m00_axi_awaddr\(4),
      m00_axi_awready => m00_axi_awready,
      m00_axi_bvalid => m00_axi_bvalid,
      m00_axi_init_axi_txn => m00_axi_init_axi_txn,
