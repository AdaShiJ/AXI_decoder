...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_mst_exec_state[1]_i_3\ : label is "soft_lutpair6";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_mst_exec_state_reg[0]\ : label is "idle:00,init_compare:11,init_read:10,init_write:01";
  attribute FSM_ENCODED_STATES of \FSM_sequential_mst_exec_state_reg[1]\ : label is "idle:00,init_compare:11,init_read:10,init_write:01";
  ...
  attribute SOFT_HLUTNM of cdmaWriteFlag_i_2 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_12 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of insDown2Flag_i_2 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \read_index[2]_i_2\ : label is "soft_lutpair15";
...
\FSM_sequential_mst_exec_state[1]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AE"
    )
        port map (
