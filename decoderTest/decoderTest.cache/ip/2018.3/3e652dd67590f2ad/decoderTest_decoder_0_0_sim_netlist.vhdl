...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal axi_araddr147_out : STD_LOGIC;
  ...
  signal cdmaWriteFlag39_out : STD_LOGIC;
  ...
  signal insFinishPulse51_out : STD_LOGIC;
  ...
  signal writeFlag5_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_araddr[2]_i_2\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \cdmaWriteFlag_reg__0_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \counter[2]_i_2\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of insFinishPulseF_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of insFinish_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of insFinish_i_3 : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of writeFlag_reg_i_1 : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of writeFlag_reg_i_2 : label is "soft_lutpair1";
...
\FSM_sequential_mst_exec_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"C0C0F0F0DFD0DFD0"
    )
        port map (
      I0 => reads_done,
      I1 => rdDmaFlag,
      I2 => mst_exec_state(0),
      I3 => \FSM_sequential_mst_exec_state[0]_i_2_n_0\,
      I4 => writes_done,
      I5 => compare_done,
...
\cdmaWriteFlag_reg__0\: unisim.vcomponents.LDCE
    generic map(
      ...
      CLR => '0',
      D => '0',
      G => cdmaWriteFlag39_out,
      GE => '1',
      Q => cdmaWriteFlag
    );
\cdmaWriteFlag_reg__0_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"8800C800"
    )
        port map (
