...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_decoder_v1_0_M00_AXI is
  ...
  signal axi_araddr0_in : STD_LOGIC_VECTOR ( 31 to 31 );
  ...
  attribute SOFT_HLUTNM of \axi_araddr[2]_i_3\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of insDown2Flag_i_6 : label is "soft_lutpair4";
...
\axi_araddr[24]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FEFECCFEFCFCFCFC"
    )
        port map (
      I0 => insFinishPulseF,
      I1 => axi_bready_i_1_n_0,
      I2 => writeFlag,
      I3 => m00_axi_arready,
      I4 => rdDmaFlag,
...
\axi_araddr[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"77F7"
    )
        port map (
